...
if(!isset($_SESSION['login']) || $_SESSION['login'] < time() && !isset($_SESSION['user']) && $_GET['page']!='adm' && $_GET['page']!='bote' && $_GET['page']!='archivment' && $_GET['page'] != 'wall' && $_GET['page']!='search' && $_GET['page']!='insertPin' && $_GET['page']!='news'){
	$_SESSION['login'] = '';
	session_destroy();
